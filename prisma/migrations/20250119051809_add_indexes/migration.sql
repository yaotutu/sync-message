/*
  ...
  - Added the required column `username` to the `card_keys` table without a default value. This is not possible if the table is not empty.
...
CREATE INDEX "card_keys_userId_idx" ON "card_keys"("userId");
...
-- CreateIndex
CREATE INDEX "user_configs_userId_idx" ON "user_configs"("userId");
